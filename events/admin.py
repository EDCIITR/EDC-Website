...
class EventAdmin(admin.ModelAdmin):
	form = EventForm	
	list_display = ('name','date_event','category','parent','separate','venue',)
	list_filter = ('category',)
	list_editable = ('category','venue','date_event',)
	ordering = ('-date_event',)
	inlines = [GuestInline,StageInline,FAQInline,SponsorInline,IncentiveInline,AnnouncementInline,] #EventInline was removed for optimisation
	search_fields = ('name',)
